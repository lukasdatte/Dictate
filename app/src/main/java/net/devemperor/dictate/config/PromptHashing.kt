...
/**
 * Computes the shareable `content_hash` of an Android `prompts` row (spec §8.5.1).
 *
 ...
 *
 * @see docs/plans/2026-07-19 - desktop-companion-v1/research/entitaetenmodell-android.md §8.5.1
 */
