...
| CR4 | CR4-RR4 | B5 | IME legacy-driver-removal (render AC-10 analogue) | **HIGHEST** (RR-1/2) | 🔄 (re-run post CR-EXT) | B5-CR4-IMPL | | |
| CR-RGATE | CR-RGATE | B5 | **render verification GATE** (authorises CR-DEL) | Gate | ⏳ | | | |
