...
| CR-RGATE | CR-RGATE | B5 | **render verification GATE** (authorises CR-DEL) | Gate | 🔄 | B5-CR-RGATE-IMPL | | |
| 10 | C10-C3 (CR-DEL) | B5 | 4-controller deletion (HARD-GATED on GREEN CR-RGATE) | Med | ⏳ | | 185f3f6 (OQ-1 only) | |
