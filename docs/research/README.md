...
| 2026-07-09 | [`external-dictation-entry-points`](<2026-07-09 - external-dictation-entry-points.md>) | Accepted | Start dictation without the keyboard: launcher alias (S-Pen/Edge/side-key pickers), static app shortcut, QS tile → one canonical ACTION_START_DICTATION service path |
| 2026-07-11 | [`widget-mode-parity-and-third-row`](<2026-07-11 - widget-mode-parity-and-third-row.md>) | Accepted | Overlay-widget parity series P1–P5: recording-wins precedence, secondary-record button, close handoff to the keyboard, third row (delete \| space \| enter) gated on canCommitToHost, press-and-hold repeat delete |
